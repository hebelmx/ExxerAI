---
description: Document all cs class on the root project and and subfolders
globs: 
alwaysApply: false
---

Scope: 
--All Class public, private, internal, all public properties and methods, all private or internal complex methods private or internal, all privatecomputed properties private
--Do not change Code
--For each affected class, metodo, property, Add XML command following Modern C#. Net Best Practices and standar
...
Comment Consistency
The comment must always be:

-- Must not change production code, only add coments
-- No behavioral change or data initialization
...
- Utilize tags like <summary>, <param>, <returns>, <exception>, etc., to organize and clarify the purpose of different code elements and their interactions. 
- Be consistent:
- Maintain a consistent style and formatting throughout your project's documentation for better readability and usability. 
- Keep documentation accurate and updated:
- Ensure that your documentation reflects the current state of your code, preventing confusion and misuse. 
- Consider using tools for validation and verification, don'use tools to do the task, can use a tool to seed a template but no the full comment:
- Tools like XML validators can help ensure the correctness and validity of your documentation. 
- Provide examples where helpful:
- Use the <example> tag to demonstrate how to use specific code elements, making it easier for users to understand and implement your API. 
- Don't state the obvious:
- Comments should add value beyond what's already visible in the code. Instead, explain the "why" and "how". 
- Use descriptive names:
- Where possible, use descriptive names for types, members, and parameters to reduce the need for extensive documentation. 
- Consider the user's perspective:
- Think about what information users would
...
*   `langword="keyword"`: A language keyword, such as `true` or one of the other valid [keywords](../keywords/).
