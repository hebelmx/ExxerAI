...
public class AgentServiceImplementationTests
{
    ...
    public async Task CreateAgentAsync_Should_ReturnFailure_When_NameIsEmptyAsync()
    {
        ...
        // Act
        var result = await _agentService.CreateAgentAsync("", "description", capabilities, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task CreateAgentAsync_Should_ReturnSuccess_When_ValidParametersProvidedAsync()
    {
        ...
        // Act
        var result = await _agentService.CreateAgentAsync("TestAgent", "Test Description", capabilities, cancellationToken: TestContext.Current.CancellationToken);
