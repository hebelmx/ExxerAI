...
{
    public class TaskServiceBehavioralTests2
    {
        private readonly ITaskRepository _taskRepository;
        private readonly ILogger<TaskService> _logger;
        private readonly TaskService _service;

        public TaskServiceBehavioralTests2()
        {
    ...
    public class WorkflowServiceBehavioralTests2
    {
        private readonly IWorkflowRepository _workflowRepository;
        private readonly ILogger<WorkflowService> _logger;
        private readonly WorkflowService _service;

        public WorkflowServiceBehavioralTests2()
        {
    ...
    public class GoogleDriveServiceBehavioralTests3
    {
        ...
        // ... (all previous using directives and classes remain unchanged)
        [Fact]
        public async Task IsDocumentModifiedAsync_Should_Return_True_When_Modified()
        {
            var documentId = "doc-modified";
