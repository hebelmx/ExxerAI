...
public class PersonaTests
{
    ...
    public void Should_SetAndGetMetadata_When_ValidKeyValueProvided()
    {
        ...
        // Act
        persona.SetMetadata("custom_key", "custom_value");

        // Assert
        persona.Metadata.ShouldContainKey("custom_key");
        persona.Metadata["custom_key"].ShouldBe("custom_value");
        persona.UpdatedAt.ShouldBeGreaterThan(originalUpdateTime);
    }

    /// <summary>
    /// Tests setting metadata with null or empty key throws exception
    /// </summary>
    [Theory]
    [InlineData(null)]
    [InlineData("")]
    ...
    /// <summary>
    /// Tests getting metadata returns default when key doesn't exist
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Tests persona default initialization
    /// </summary>
    [Fact]
