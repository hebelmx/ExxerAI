...
public static class DocumentProcessingTools
{
	...
	public static Task<string> ProcessDocumentAsync(
	...
	public static Task<string> ExtractFieldsAsync(
	...
	public static Task<string> ValidateExtractedDataAsync(
	...
	public static Task<string> LearnDocumentSchemaAsync(
	...
	public static Task<string> GetProcessingConfidenceAsync(
