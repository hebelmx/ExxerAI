...
public static class GoogleDriveTools
{
	...
	public static Task<string> StartFolderWatchAsync(
	...
	public static Task<string> GetDocumentChangesAsync(
	...
	public static Task<string> DownloadDocumentAsync(
	...
	public static Task<string> GetDocumentMetadataAsync(
		[Description("The Google Drive document ID")] string documentId)
	{
	...
	public static Task<string> CheckHealthStatusAsync()
	{
	...
	public static Task<string> GetActiveWatchesAsync()
	{
	...
	public static Task<string> StopWatchingAsync(
